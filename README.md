...
## 2. Project Title 2: [Another Catchy/Descriptive Name]

**Course:** [e.g., Urban Planning Seminar]
**Date:** [e.g., Spring 2024]
**Keywords:** [e.g., GIS, Urban Design, Policy Analysis]

This project explored **[briefly explain the main objective or problem this project addressed]**. We applied **[mention key methodologies, theories, or approaches used]** to **[explain what you did]**. The project aimed to **[state the intended outcome or contribution]**. Significant takeaways included **[mention 1-2 significant results or conclusions]**.
